...
När du har klonat ner repot så öppnar du mappen i Visual Studio Code. I repot finns beskrivning av hur applikationen startas, I den här guiden används alternativet med en konfigurationsfil i YAML format.
